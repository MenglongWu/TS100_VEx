...
// flash 产品防拷贝，
// 注意！！！！！！！！！！！！！！！！！
// 调用后FLASH将不能再次烧录，必须用 UnProtectFlash解锁

// 下面介绍两种情况，只有存在J-Link 烧写失败的情况下才导致Flash解锁后全部被自动擦除
// 1. ProtectFlash   --- J-Link烧录  --- 烧录失败 --- UnProtectFlash --- Flash 被擦除
// 2. ProtectFlash   --- UnProtectFlash --- Flash 可以读写并未被擦除，可以重复调用上面两个函数
